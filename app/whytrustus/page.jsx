...
import { TrendingUp, ArrowUp, Infinity, Plus, IndianRupee } from "lucide-react";
import { Smartphone, Mail, Shield, MessageSquare } from "lucide-react";
...
const page = () => {
  ...
  const faqs = [
    ...
    {
      question: "Can I use this alongside my existing marketplace listings?",
      answer:
  ...
  return (
    <div>
      <section className="bg-white py-7 lg:py-20 mt-10 lg:mt-25">
        <div className="max-w-5xl mx-auto px-6 text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-3 border border-[#ef6b2e] rounded-xl px-3 py-2 lg:px-5 lg:py-3 text-[#ef6b2e] text-sm font-medium bg-white">
            <span className="w-2 h-2 rounded-full bg-[#ef6b2e]" />
            India's Hybrid B2B Marketplace
          </div>

          {/* Heading */}
          <h1 className="mt-5 text-[30px] md:text-[68px] leading-6\7 lg:leading-[1.05] font-semibold tracking-[-2px] text-[#1D3A76]">
            Stop competing for leads.
            <br />
            <span className="text-[#F27A1B]">Start owning them.</span>
          </h1>

          {/* Description */}
          <p className="mt-5 max-w-4xl mx-auto lg:text-[20px] lg:leading-[1.9] text-black font-normal">
            See why smart businesses are switching from traditional marketplaces
            to Inquiry Bazaar — where every lead is exclusive, verified, and
            goes directly to you.
          </p>

          {/* Buttons */}
          <div className="flex flex-col sm:flex-row justify-center gap-3 lg:gap-5 mt-6">
            <a href="https://seller.inquirybazaar.com/register">
              <button className="h-[58px] px-6 lg:px-10 rounded-xl bg-[#ef6b2e] text-white font-semibold lg:text-lg hover:scale-105 transition-all duration-300">
                Get exclusive leads
              </button>
            </a>

            <a href="/contact-us">
              <button className="h-[58px] px-4 lg:px-10 rounded-xl border border-gray-300 bg-white text-black font-medium lg:text-lg hover:bg-gray-50 transition-all duration-300">
                Book free demo
              </button>
            </a>
          </div>
          ...
          <div className="mt-8 max-w-5xl mx-auto bg-white rounded-3xl border border-gray-200 overflow-hidden shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-3">
              <div className="py-5 lg:py-8 px-3 lg:px-5 border-b md:border-b-0 md:border-r border-gray-200">
                ...
                <p className="mt-2 text-[#7b8190] text-md">
                  internet traffic in india comes from mobile phones - your
                  buyers are searching on the go not at a desk
                </p>
              </div>
              ...
              <div className="py-8 px-5 border-b md:border-b-0 md:border-r border-gray-200">
                ...
                <p className="mt-2 text-[#7b8190] text-md">
                  internet uers research products and brands on social pltforms
              ...
              <div className="py-8 px-3">
                ...
                <p className="mt-2 text-[#7b8190] text-md">
                  B2B buyers never scroll past Google's first page - if your
                  business isn't there, it simply doesn't exist to them
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#F5F5F3] py-10">
        <div className="w-full mx-auto px-6  text-center">
          ...
          {/* Heading */}
          <h2 className="max-w-[900px] mx-auto text-[30px] md:text-[46px] leading-[1.12] font-semibold text-[#1D3A76] tracking-[-1.8px]">
            Why businesses fail on traditional marketplaces
          </h2>

          {/* Description */}
          <p className="mt-6 max-w-[650px] mx-auto text-[18px] lg:leading-[1.8] text-black">
          ...
          <div className="grid md:grid-cols-2 gap-5 mt-4 max-w-7xl mx-auto text-left">
            {problems.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex items-start gap-4 rounded-2xl border border-[#e8e8e8] bg-white px-3 lg:px-4 py-3 lg:py-4 transition-all duration-300 hover:shadow-md"
                >
                  ...
                  <p className="text-[18px] lg:leading-[1.7] text-[#1d2939] lg:font-medium">
                    {item.text}
                  </p>
                </div>
              );
          ...
          <div className="mt-3 max-w-5xl mx-auto rounded-xl border border-[#f5c7be] bg-[#fff5f2]">
            <div className="flex items-center justify-center gap-4 px-7 py-6 border-l-4 border-[#e14d2a]">
              <AlertCircle size={18} className="text-[#a13c26] shrink-0" />
      ...
      <section className="bg-white py-5">
        <div className="w-full mx-auto px-6">
          ...
          {/* Heading */}
          <h2 className="text-center text-[30px] md:text-[56px] font-semibold lg:leading-[1.1] tracking-[-2px] text-[#1D3A76]">
            Inquiry Bazaar vs traditional marketplaces
          </h2>

          {/* Description */}
          <p className="mt-2 max-w-3xl mx-auto text-center lg:text-[22px] lg:leading-[1.8] text-black">
            A clear, honest feature comparison — see exactly what changes when
            you move to Inquiry Bazaar.
          </p>

          {/* Table */}
          <div className="mt-4 max-w-7xl mx-auto overflow-x-auto">
            <div className="min-w-[700px] lg:min-w-[900px] overflow-hidden rounded-2xl border border-[#e5e5e5] bg-white">
              {/* Header */}
              ...
              {comparisonData.map((item, index) => (
                ...
                >
                  {/* Feature */}
                  <div className="px-4 lg:px-8 py-4 text-[18px] text-[#344054] font-medium transition-all duration-300 group-hover:text-black">
                    {item.feature}
                  </div>
      ...
      <section className="bg-[#f8f8f8] py-6">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* Description */}
          <p className="my-3 max-w-5xl mx-auto text-center text-base lg:text-[20px] lg:leading-[1.8] text-black">
            See exactly why traditional platforms lose buyers — and why Inquiry
            Bazaar closes deals faster.
          </p>
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 py-4 px-6">
              {[
                ...
                <div key={index} className="flex items-center gap-2 lg:gap-4">
                  <div className="rounded-xl border border-[#efb4aa] bg-[#fff7f5] px-3 lg:px-6 lg:py-3 text-[#d94b37] font-medium transition-all duration-300 hover:scale-105 hover:bg-[#fff0ec]">
                    {item}
                  </div>
          ...
          <div className="mt-6 max-w-7xl mx-auto overflow-hidden rounded-2xl border border-[#9ad5c2] bg-white shadow-sm transition-all duration-500 hover:shadow-xl">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 py-4 px-6">
              {[
                ...
                <div key={index} className="flex items-center gap-1 lg:gap-4">
                  <div className="rounded-xl border border-[#98d6bf] bg-[#f4fffa] px-3 lg:px-6 py-1 lg:py-3 text-[#027a48] font-medium transition-all duration-300 hover:scale-105 hover:bg-[#ecfff6]">
                    {item}
                  </div>
      ...
      <section className="bg-white py-7 lg:py-10">
        <div className="mx-auto max-w-[1440px] px-5 lg:px-12">
          ...
          {/* Heading */}
          <h2 className="max-w-[780px] text-[30px] mt-5 lg:text-[44px] font-semibold leading-[1.08] tracking-[-0.03em] text-[#1D3A76]">
            Built for results, not just listings
          </h2>

          {/* Description */}
          <p className="mt-5 lg:mt-2 max-w-[760px] lg:text-[20px] lg:leading-[1.8] text-[#5c6470]">
    ...
    {features.map((item) => {
      ...
      return (
        <SwiperSlide key={item.title}>
          <div className="group relative overflow-hidden rounded-2xl border border-[#dddddd] bg-white px-3 lg:px-8 py-3 lg:py-5 transition-all duration-500 hover:-translate-y-3 hover:border-[#e56d2e] hover:shadow-[0_20px_50px_rgba(229,109,46,0.15)]">
            {/* Background Gradient */}
            ...
            <div className="relative z-10">
              ...
              <p className="text-[17px] leading-6 lg:leading-[1.9] text-black/80 transition-all duration-300 group-hover:text-black">
                {item.description}
              </p>
            </div>
          </div>
...
{/* Desktop Grid */}
<div className="mt-8 hidden grid-cols-1 gap-5 md:grid md:grid-cols-2">
  {features.map((item) => {
    const Icon = item.icon;
    ...
    return (
      ...
      <section className="bg-[#f6f6f5] py-10">
        <div className="mx-auto flex flex-col items-center ">
          ...
          {/* Heading */}
          <h2 className=" text-center text-[30px] lg:text-[46px] font-medium leading-[1.1] tracking-[-0.04em] text-[#1D3A76]">
            Stop selling on price. Start building a brand.
          </h2>

          {/* Description */}
          <p className="mt-6 lg:mt-3 max-w-[960px] px-4 lg:px-0 text-center lg:text-[18px] leading-6 lg:leading-[2] text-[#5c6470]">
            On traditional platforms you are a commodity. On Inquiry Bazaar, you
            are a trusted brand.
          </p>
      ...
      <section className="bg-[#f6f6f5] px-3 lg:py-[20px]">
        <div className="mx-auto flex w-full  flex-col items-center lg:px-6">
          {/* Section Label */}
          ...
          {/* Heading */}
          <h2 className=" text-center text-[30px] lg:text-[56px] font-medium leading-[1.08] tracking-[-0.04em] text-[#1D3A76]">
            What this means for your business
          </h2>

          {/* Description */}
          <p className="mt-5 lg:mt-3  text-center lg:text-[18px] lg:leading-[2] text-black">
            Switching to Inquiry Bazaar is a growth strategy upgrade — not just
            a platform change.
          </p>

          {/* Cards Grid */}
          <div className=" mt-[20px] pb-4  w-full lg:hidden mx-auto overflow-hidden">
  <Swiper
    modules={[Pagination, Autoplay]}
    slidesPerView={2}
    spaceBetween={16}
    ...
    {impacts.map((item, index) => {
      ...
      return (
        <SwiperSlide key={index} className="">
          ...
          <div className="mx-auto hidden lg:grid mt-[20px]  px-5 lg:px-20 grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
            {impacts.map((item, index) => {
              const Icon = typeof item.icon !== "string" ? item.icon : null;
      ...
      <section className="bg-white py-[22px]">
        <div className="mx-auto flex w-full flex-col items-center px-6">
          ...
          {/* Description */}
          <p className="mt-4  text-center lg:text-[18px] lg:leading-[2] text-black">
          ...
          {/* Cards */}
         {/* Mobile Slider */}
<div className="mt-5 w-full mx-auto lg:hidden px-5 ">
  <Swiper
    modules={[Pagination, Autoplay]}
    slidesPerView={1}
    spaceBetween={4}
      ...
      <SwiperSlide key={item.title} className="">
        ...
        >
          ...
          <div className="relative z-10 flex gap-4">
            ...
            {/* Content */}
            <div>
              <h3 className="text-[18px] font-medium text-[#070707]">
                {item.title}
              </h3>

              <p className="mt-2 text-[15px] leading-[1.8] text-black">
                {item.description}
              </p>
            </div>
          </div>
...
{/* Desktop Grid */}
<div className="mt-5 hidden w-full grid-cols-1 gap-4 px-5 lg:grid lg:px-20 md:grid-cols-2">
  {transparencyItems.map((item) => (
    <div
      key={item.title}
      className="
    ...
    >
      ...
      <section className="bg-[#f6f6f5] py-10">
        <div className="mx-auto max-w-[1440px] px-6">
          ...
          {/* Heading */}
          <h2 className="mb-5 text-[30px] lg:text-[56px] font-medium leading-[1.08] tracking-[-0.04em] text-[#1D3A76]">
            ...
            {testimonials.map((item) => (
              <SwiperSlide key={item.name}>
                <div className="h-full rounded-[16px] border border-[#dddddd] bg-white p-3 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                  ...
                  {/* Review */}
                  <p className="min-h-[150px] lg:text-[18px] italic leading-[1.9] text-[#434343]">
                    "{item.review}"
                  </p>
      ...
      <section className="bg-[#f6f6f5] py-12">
        <div className="mx-auto w-full px-5 lg:px-[44px]">
          {/* Header */}
          <div className="mb-4 flex items-center gap-2">
            <div className="h-px w-5 bg-[#eb6425]" />
            <span className="text-[13px] uppercase tracking-[3px] text-[#eb6425]">
          ...
          <h2 className="text-[30px] lg:text-[56px] font-medium leading-[1.08] tracking-[-0.04em] text-[#1D3A76]">
            Objections answered honestly
          </h2>

          <p className="mt-4 lg:text-[18px] text-[#1D3A76]">
            Real questions from businesses evaluating Inquiry Bazaar — answered
            straight.
          </p>
                        ...
                        <div className="overflow-hidden">
                          <div className="px-6 pb-6">
                            <div className="flex gap-6">
                              ...
                              <p className="max-w-[700px] text-[17px] lg:leading-[2] text-[#616977]">
                                {faq.answer}
                              </p>
                            </div>
                          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                <span className="relative z-10">
                  {loading ? "Submitting..." : "Get My First Exclusive Lead"}
                </span>
              ...
              <p className="text-center text-xs text-[#7a828f]">
                By submitting this form, you agree to receive calls and messages
      ...
      <section className="bg-black py-[26px]">
        <div className="mx-auto flex max-w-[1440px] flex-col items-center px-6 text-center">
          {/* Heading */}
          <h2 className="max-w-[700px] text-[33px] lg:text-[64px] font-medium leading-[1.05] tracking-[-0.04em] text-white">
          ...
          {/* Description */}
          <p className="mt-8 max-w-[760px] lg:text-[18px] lg:leading-[1.9] text-white">
            Join businesses moving beyond traditional marketplaces and building
            real, lasting growth systems with Inquiry Bazaar.
          </p>

          {/* Buttons */}
          <div className="mt-8 lg:mt-12 flex flex-col gap-3 lg:gap-4 sm:flex-row">
            {/* Primary CTA */}
