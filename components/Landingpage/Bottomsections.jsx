...
export default function Footer() {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="flex gap-3 items-start">
            ...
            <div>
              ...
              <p>
                Connect with trusted manufacturers & wholesalers. Every supplier
                is screened for quality and reliability.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3 items-start">
            ...
            <div>
              ...
              <p>
                Get multiple quotations within hours of posting your
                requirement. Save time and close deals faster.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3 items-start">
            ...
            <div>
              ...
              <p>
                Explore lakhs of products across multiple industries. One
                platform for all your B2B sourcing needs.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div>
            ...
            <ul className="space-y-1">
              <div>
                <Link href="https://corporate.inquirybazaar.com/about/whoweare">
                  About Us
                </Link>
              </div>
              ...
              <div>
                <Link href="https://corporate.inquirybazaar.com/career">
                  Careers
                </Link>
              </div>
              ...
              <div>
                <Link href="https://corporate.inquirybazaar.com/blogs">
                  Blog
                </Link>
              </div>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <a href="https://www.promotionbranding.com/">
                  Promotion Branding
                </a>
              </li>
              ...
              <li>
                <a href="https://promozionebranding.com/">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <a href="mailto:care@inquirybazaar.com">Write to Management</a>
              </li>
            </ul>
          </div>
  ...
  <div className="bg-[#f3f3f3] rounded-2xl lg:rounded-full p-1">
    <div className="flex flex-col xl:flex-row xl:items-center">
      ...
      <button
        ...
        disabled={loading}
        className="hidden lg:block bg-black text-white text-[12px] px-4 py-2 rounded-full disabled:opacity-50"
      >
    ...
    <button
      onClick={handleSubscribe}
      disabled={loading}
      className="mt-2 w-full lg:hidden bg-black text-white text-[12px] px-4 py-2 rounded-full disabled:opacity-50"
    >
      {loading ? "SUBSCRIBING..." : "SUBMIT NOW"}
    </button>
  </div>
