...
<div className="grid grid-cols-2 gap-4 mt-2">
  ...
  {/* ICON */}
  <button className="mt-4  text-white px-2 py-1 rounded-lg bg-[#f48335] w-fit hover:shadow-md transition">
  ...
  {data2.map((item, i) => (
    ...
    >
      ...
      <Image
        ...
        width={90}
        height={90}
        className="absolute right-0 -bottom-2 object-contain group-hover:opacity-100  transition-all duration-300 z-0"
      />
    </div>
  ))}
</div>
